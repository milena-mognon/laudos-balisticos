...
class Espingarda extends Model
{
    ...
    private static function espingarda_artesanal($arma)
    {
        ...
        $corpo = "Trata-se de uma " . mb_strtolower($arma->tipo_arma) . " de tiro unitário simples, sem marca aparente, sem número de série, de calibre nominal $calibre, com sistema de carregamento tipo antecarga, $coronha_fuste $bandoleira, em $arma->estado_geral estado de conservação. Suas medidas são: comprimento total: $arma->comprimento_total" . "m e o cano mede $arma->comprimento_cano" . "m.";
