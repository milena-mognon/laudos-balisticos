...
<div class="col-lg-12" style="padding: 0 5% 0">
    <div class="row mb-3">
        ...
        @include('perito.armas.attributes2.disposicao_canos', ['disposicao_canos2' =>  $espingarda->disposicao_canos ?? old('disposicao_canos')])
        @include('perito.armas.attributes2.teclas_gatilho', ['teclas_gatilho2' =>  $espingarda->teclas_gatilho ?? old('teclas_gatilho')])
        @include('perito.armas.attributes2.sistema_carregamento', ['sistema_carregamento2' =>  $espingarda->sistema_carregamento ?? old('sistema_carregamento')])
        @include('perito.armas.attributes2.chave_abertura', ['chave_abertura2' =>  $espingarda->chave_abertura ?? old('chave_abertura')])
        ...
        @include('perito.armas.attributes2.comprimento_cano', ['comprimento_cano' =>  $espingarda->comprimento_cano ?? old('comprimento_cano')])
        @include('perito.armas.attributes2.funcionamento', ['funcionamento2' =>  $espingarda->funcionamento ?? old('funcionamento')])
        @include('perito.armas.attributes2.lacre', ['num_lacre' =>  $espingarda->num_lacre ?? old('num_lacre')])
    </div>
