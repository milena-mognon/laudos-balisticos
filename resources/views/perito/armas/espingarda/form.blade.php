...
<div class="col-lg-12" style="padding: 0 5% 0">
    <div class="row mb-3">
        ...
        @include('perito.attributes2.calibre_real', ['calibre_real' =>  $espingarda->calibre_real ?? old('calibre_real')])
        ...
        @include('perito.attributes2.bandoleira', ['bandoleira2' =>  $espingarda->bandoleira ?? old('bandoleira')])
