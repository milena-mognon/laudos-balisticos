...
<div class="col-lg-12" style="padding: 0 5% 0">
    <div class="row mb-3">
        ...
        @include('perito.armas.attributes2.carregamento', ['carregamento2' =>  $pistola->carregamento ?? old('carregamento')])
        @include('perito.armas.attributes2.cao', ['cao2' =>  $pistola->cao ?? old('cao')])
        @include('perito.armas.attributes2.carregador', ['carregador2' =>  $pistola->carregador ?? old('carregador')])
        @include('perito.armas.attributes2.capacidade_carregador', ['capacidade_carregador' =>  $pistola->capacidade_carregador ?? old('capacidade_carregador')])
        @include('perito.armas.attributes2.retem_carregador', ['retem_carregador2' =>  $pistola->retem_carregador ?? old('retem_carregador')])
        @include('perito.armas.attributes2.trava_ferrolho', ['trava_ferrolho2' =>  $pistola->trava_ferrolho ?? old('trava_ferrolho')])
        @include('perito.armas.attributes2.trava_gatilho', ['trava_gatilho2' =>  $pistola->trava_gatilho ?? old('trava_gatilho')])
        @include('perito.armas.attributes2.trava_seguranca', ['trava_seguranca2' =>  $pistola->trava_seguranca ?? old('trava_seguranca')])
