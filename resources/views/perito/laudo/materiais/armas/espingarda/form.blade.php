...
<div class="col-lg-12" style="padding: 0 5% 0">
    <div class="row mb-3">
        ...
        @include('perito.laudo.materiais.attributes.disposicao_canos', ['disposicao_canos2' =>  $espingarda->disposicao_canos ?? old('disposicao_canos')])
        @include('perito.laudo.materiais.attributes.teclas_gatilho', ['teclas_gatilho2' =>  $espingarda->teclas_gatilho ?? old('teclas_gatilho')])
        @include('perito.laudo.materiais.attributes.sistema_carregamento', ['sistema_carregamento2' =>  $espingarda->sistema_carregamento ?? old('sistema_carregamento')])
        @include('perito.laudo.materiais.attributes.chave_abertura', ['chave_abertura2' =>  $espingarda->chave_abertura ?? old('chave_abertura')])
        @include('perito.laudo.materiais.attributes.sistema_engatilhamento', ['sistema_engatilhamento2' =>  $espingarda->sistema_engatilhamento ?? old('sistema_engatilhamento')])
        @include('perito.laudo.materiais.attributes.tipo_acabamento', ['tipo_acabamento2' =>  $espingarda->tipo_acabamento ?? old('tipo_acabamento')])
        ...
        @include('perito.laudo.materiais.attributes.sistema_percussao', ['sistema_percussao2' =>  $espingarda->sistema_percussao ?? old('sistema_percussao')])
        @include('perito.laudo.materiais.attributes.estado_geral', ['estado_geral2' =>  $espingarda->estado_geral ?? old('estado_geral')])
        @include('perito.laudo.materiais.attributes.comprimento', ['comprimento_total' =>  $espingarda->comprimento_total ?? old('comprimento_total')])
        @include('perito.laudo.materiais.attributes.comprimento_cano', ['comprimento_cano' =>  $espingarda->comprimento_cano ?? old('comprimento_cano')])
        @include('perito.laudo.materiais.attributes.funcionamento', ['funcionamento2' =>  $espingarda->funcionamento ?? old('funcionamento')])
