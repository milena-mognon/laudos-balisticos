...
@section('page')
    ...
    <div class="col-lg-4">
        @include('shared.block_button', ['col_name' => 'tipo_arma', 'value' => 'Revólver', 'route' => 'revolveres.create', 'laudo' => $laudo])
        ...
        @include('shared.block_button', ['col_name' => 'tipo_arma', 'value' => 'Espingarda', 'route' => 'espingardas.create'])
