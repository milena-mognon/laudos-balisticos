...
Route::prefix('laudos/{id}')->group(function () {
...
Route::get('materiais/{laudo_id}', 'Perito\LaudosController@materiais')->name('laudos.materiais');
Route::get('gerar/{laudo}', 'Perito\LaudosController@generate')->name('laudos.generate');